...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Tweet__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_schedule_tweets__ = __webpack_require__(25);
...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.updateTweet = _this.updateTweet.bind(_this);
  ...
  _createClass(App, [{
    ...
    key: 'updateTweet',
    value: function updateTweet(index, newTweetBody) {
      var tweets = [].concat(_toConsumableArray(this.state.tweets));
      tweets[index].body = newTweetBody;
      this.setState({ tweets: tweets });
    }
  }, {
    key: 'updateInterval',
    value: function updateInterval(e) {
    ...
    value: function schedule(e) {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_2__services_schedule_tweets__["a" /* default */])(tweets, interval);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var tweetRows = this.state.tweets.map(function (tweet, i) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Tweet__["a" /* default */], { key: i, index: i, tweet: tweet, onChange: _this2.updateTweet });
      });
...
var _class = function (_Component) {
  ...
  function _class(props) {
    ...
    _this.state = {
      tweetBody: _this.props.tweet.body
    };
...
var postTweet = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(tweets, i, interval) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return timeout(interval * 60 * 1000);

          case 4:
            _context2.next = 6;
            return postTweet(tweets, i + 1, interval);
  ...
  return function postTweet(_x3, _x4, _x5) {
...
/* harmony default export */ __webpack_exports__["a"] = ((function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee(tweets, interval) {
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return postTweet(tweets, 0, interval);
  ...
  function scheduleTweets(_x, _x2) {
    return _ref.apply(this, arguments);
  }

  return scheduleTweets;
})());
